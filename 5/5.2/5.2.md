...
Registra la relación entre un usuario y una sesión específica de inducción. Esta entidad representa el listado de participantes asignados a una inducción y permite registrar posteriormente su estado de asistencia.

| Atributo      | Tipo de Dato | Formato     | Valores Válidos                     | Semántica                 |
|---------------|--------------|----------|---------------------------------------|--------------------------------------------------|
| idParticipacionI   | CHAR          | X(8)       | NOT NULL, UNIQUE              | Identificador del registro de participación   |
