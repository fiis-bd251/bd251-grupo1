...
| estado                 | CHAR         | X(3)     | TAB14                 | Estado de usabilidad de la maquinaria o herramienta |
...
| estado                 | Estado       | X(3)     | TAB15                 | Estado de cumplimiento de la inspección             | 
...
| estado                       | CHAR         | X(3)     | TAB16                 | Estado de la toma de decisión de Acción Correctiva  |
| decision                     | CHAR         | X(3)     | TAB17                 | Indica la Accion Correctiva tomada                  | 
