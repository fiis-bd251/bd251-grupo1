...
| N° | Actividad | Descripción | Responsable |
|----|-----------|-------------|-------------|
|1. |Planificación de la inspección|	Se elabora un cronograma de inspecciones basado en la criticidad de las áreas y el historial de incidentes. Se determinan los criterios de evaluación según normativas de seguridad internas y legales.|	Gerente de HSE
...
|6. |Definición de acciones correctivas|	Se establecen medidas para corregir las no conformidades detectadas. Estas pueden incluir capacitaciones, cambios en procedimientos, mejoras en infraestructura o reforzamiento de normativas.|	Gerente de HSE
...
|9. |Cierre de hallazgos|	Una vez verificadas y aprobadas las acciones correctivas, se cierra formalmente el hallazgo y se actualiza la base de datos de inspecciones.|	Cordinador de HSE
