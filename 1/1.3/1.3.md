...
|----|-----------|-------------|-------------|
## 2.	Proceso de Gestión de Capacitaciones
Este flujo representa un proceso de intervención humana y sistema coordinados.

| Secuencia | Actividad                       | Descripción                                                                                         | Responsable       |
| --------- | ------------------------------- | --------------------------------------------------------------------------------------------------- | ----------------- |
| 1         | Identificar necesidades         | Se identifican las áreas donde se requieren capacitaciones mediante encuestas y evaluaciones.       | Coordinador RH    |
| 2         | Diseñar programa                | Se elabora un programa de capacitación ajustado a las necesidades identificadas.                   | Equipo de RH      |
| 3         | Aprobar programa                | El programa diseñado es enviado para aprobación al gerente o responsable del área.                 | Gerente del Área  |
| 4         | Convocar a participantes        | Se informa a los empleados seleccionados sobre la capacitación programada a través de correos u otros medios. | Coordinador RH |
| 5         | Gestionar logística             | Se coordinan los recursos necesarios como lugar, materiales, instructores y horarios.              | Coordinador RH    |
| 6         | Impartir capacitación           | Se ejecuta el programa de capacitación según lo planeado.                                           | Instructores      |
| 7         | Evaluar resultados              | Se aplican encuestas o exámenes para evaluar la eficacia del programa y el aprendizaje obtenido.    | Coordinador RH    |
| 8         | Registrar información           | Se actualizan los registros de capacitación en el sistema, incluyendo asistentes y resultados.      | Administrador RH  |
| 9         | Implementar mejoras             | Basado en las evaluaciones, se hacen ajustes para futuras capacitaciones.                          | Equipo de RH      |
