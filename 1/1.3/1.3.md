...
| 4         | Revisar y preparar los materiales | Se revisan los materiales diseñados y se realizan ajustes si es necesario.                        | Instructores      |
| 5         | Impartir las sesiones            | Se ejecuta el programa de capacitación según lo planificado.                                      | Instructores      |
| 6         | Participar en las sesiones       | Los empleados asisten y participan en la capacitación.                                            | Participantes     |
