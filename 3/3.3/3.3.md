...
| R011          | Consultar historial de comunicados                                     |
| R012          | Editar comunicado                                                      |
| R013          | Consultar comunicados pendientes                                       |
| R014          | Asignar destinatarios                                                  |
| R015          | Verificar confirmaciones                                               |
| R016          | Ver estado de confirmación por trabajador                              |
| R017          | Acceder a comunicados recibidos                                        |
| R018          | Verificar lectura del comunicado                                       |
