...
| R029          | Panel Indicadores                        |
| R030          | Historial de Reportes Generados          |
| R031          | Exportar reportes                        |
| R032          | Programar Envio Automatico               |

## 🎯 R029 - Generar reportes
### 📝 Caso de Uso
...
| **Postcondición** | El informe se almacena correctamente en la base de datos. |
| **Casos de uso incluidos** | Validar datos del formulario, Guardar reporte. |
| **Requesito no funcional** | Tiempo de respuesta menor a 2x; Interfaz intuitiva; Validacion automática. |

## 🎯 R029 - Visualizar resultados en formato tabular
### 📝 Caso de Uso
...
| **Postcondición** | Visualizacion ecitosa de los datos en formato estruturado. |
...
| **Postcondición** | Se muestran solo los reportes que cumples los criterios. |
| **Casos de uso incluidos** | Carga de lista, paginacion de resultados. |
| **Requesito no funcional** | Búsqueda ágil, respuesta menor a 3 segundos, respuesta clara. |

## 🎯 R029 - Editar Reportes
### 📝 Caso de Uso
...
## 🎯 R029 - Historial de Reportes Generados
### 📝 Caso de Uso
...
| **Postcondición** | Visualizacion correcta de historial de reportes. |
| **Casos de uso incluidos** | Validacion de correo, conecion SMTP. |
| **Requesito no funcional** | Graficos dinámicos, interpretacion clara, esportacion disponible. |

## 🎯 R029 - Exportar reportes
### 📝 Caso de Uso
...
## 🎯 R029 - Programar Envio Automatico
### 📝 Caso de Uso
...
| **Postcondición** | El sistema enviara automaticamente los reportes segun programacion. |
| **Casos de uso incluidos** | Validación de correo, seleccion de periocidad. |
