...
| **Actor iniciador** | Supervisor HSE |
| **Actor principales** | Supervisor HSE, Sistema de Gestión de Reportes |
| **Flujo de eventos** | 1. El usuario accede a la sección "Historial de Reportes Generados". <br> 2. El sistema muestra una lista de los reportes generados con sus detalles (Nombre, Fecha de Creación, Frecuencia, Área de Trabajo, Descripción, Tipo de Reporte, Estado, y posiblemente una opción para Ver/Descargar). <br> 3. Para Filtrar (opcional): <br>    a. El usuario selecciona criterios de filtrado (Área de Trabajo, Tipo de Reporte, Frecuencia, rango de fechas/horas, nombre). <br>    b. El usuario hace clic en "Buscar". <br>    c. El sistema actualiza la lista de reportes según los criterios. <br>    d. El usuario puede hacer clic en "Limpiar Filtros" para restablecer la lista completa. <br> 4. Para Ver/Descargar (opcional): <br>    a. El usuario selecciona la opción para ver o descargar un reporte específico. <br>    b. El sistema muestra el reporte en pantalla o inicia la descarga del archivo. |
...
| **Actor iniciador** | Supervisor HSE |
| **Actor principales** | Supervisor HSE &lt;br> Sistema de Gestión de Reportes &lt;br> Servidor de Correo Electrónico |
