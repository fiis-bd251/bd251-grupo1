...
|---------------|----------------------------------------|
| R015       | Programar inducción                    |
| R016       | Consultar inducciones programadas      |
| R017      | Editar una inducción programada        |
| R018      | Consultar historial de inducciones     |
| R019      | Acceder a la inducción asignada        |
| R020       | Rendir evaluación de inducción         |
| R021      | Consultar historial de inducciones (Trabajador) |
