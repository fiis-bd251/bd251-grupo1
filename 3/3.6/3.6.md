...
# 3.6. Gestión de Difusiones y Comunicados HSE
...
| 3    | Selecciona el mes que desea crear/editar.                     |
| 4    | Selecciona e ingresa  la maquinaria/herramienta, fecha y descripción de la inspección.                |
| 5    | Hace clic en "Guardar".                                            |
| 6    | El sistema valida la información ingresada.                        |
| 7    | El sistema guarda/actualiza el nuevo crenograma en la base de datos.               |
...
| **Descripción**       | El usuario podrá subir hallasgos puntuales y una descripcion general. |
...
| 3    | Selecciona la inspeccion correspondiente e ingresa sus hallasgos y descripción.                      |
...
| **Actor secundario**  | Supervisor de HSE                                                                    |
